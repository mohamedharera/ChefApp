...
import com.elchefapp.elchefapp.activities.ChefDetailsActivity;
import com.elchefapp.elchefapp.models.models_client.places.ClassCustomerPlacesDatum;

import java.util.ArrayList;
import java.util.List;

public class RecylerAdapterCustomerPlaces extends RecyclerView.Adapter<RecylerAdapterCustomerPlaces.ViewHolder> implements Filterable {
    List<ClassCustomerPlacesDatum> mData;
    Context mContext;
    List<ClassCustomerPlacesDatum> mDataFull;


    public RecylerAdapterCustomerPlaces(List<ClassCustomerPlacesDatum> Data, Context context) {
        this.mData = Data;
