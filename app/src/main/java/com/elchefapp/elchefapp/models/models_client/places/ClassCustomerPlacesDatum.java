package com.elchefapp.elchefapp.models.models_client.places;
...
public class ClassCustomerPlacesDatum {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @Expose
    private List<ClassCustomerPlacesImage> images = new ArrayList<>();
    @SerializedName("foods")
    @Expose
    private List<ClassCustomerPlacesFood> foods = new ArrayList<>();
    ...
    public List<ClassCustomerPlacesImage> getImages() {
        return images;
    }

    public void setImages(List<ClassCustomerPlacesImage> images) {
        this.images = images;
    }

    public List<ClassCustomerPlacesFood> getFoods() {
        return foods;
    }

    public void setFoods(List<ClassCustomerPlacesFood> foods) {
        this.foods = foods;
    }
}
