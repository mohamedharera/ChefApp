...
public class ClassCustomerRestaurantDetailsData {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @Expose
    private List<ClassCustomerRestaurantDetailsImages> images = new ArrayList<>();
    @SerializedName("foods")
    @Expose
    private List<ClassCustomerRestaurantDetailsFood> foods = new ArrayList<>();
    ...
    public List<ClassCustomerRestaurantDetailsImages> getImages() {
        return images;
    }

    public void setImages(List<ClassCustomerRestaurantDetailsImages> images) {
        this.images = images;
    }

    public List<ClassCustomerRestaurantDetailsFood> getFoods() {
        return foods;
    }

    public void setFoods(List<ClassCustomerRestaurantDetailsFood> foods) {
        this.foods = foods;
    }
}
