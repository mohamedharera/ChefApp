...
public class ClassChefRestaurantListslData {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @Expose
    private List<ClassChefRestaurantListsImages> images = new ArrayList<>();
    @SerializedName("foods")
    @Expose
    private List<ClassChefRestaurantListsFood> foods = new ArrayList<>();
    ...
    public List<ClassChefRestaurantListsImages> getImages() {
        return images;
    }

    public void setImages(List<ClassChefRestaurantListsImages> images) {
        this.images = images;
    }

    public List<ClassChefRestaurantListsFood> getFoods() {
        return foods;
    }

    public void setFoods(List<ClassChefRestaurantListsFood> foods) {
        this.foods = foods;
    }
