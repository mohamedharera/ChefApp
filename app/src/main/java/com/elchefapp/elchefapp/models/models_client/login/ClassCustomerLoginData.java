...
public class ClassCustomerLoginData {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public ClassCustomerLoginData(int id, String name, String email, String address, String image, String mobile) {
    }
    public ClassCustomerLoginData() {
    }
